...
c     $id$
c
c     Contents: FORTRAN 77 reference implementation for the Level 1 BLAS.
c     
c     Reference: The subprograms in this modules can be obtained from
c     the Netlib <http://www.netlib.org/>
c     
c     ------------------------------------------------------------------
